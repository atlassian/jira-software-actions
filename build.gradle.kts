...
publishing {
    val publication = publications.create("mavenJava", MavenPublication::class.java) {
        pom {
            scm {
                url.set("https://bitbucket.org/atlassian/jira-software-actions")
                connection.set("scm:git:git@bitbucket.org:atlassian/jira-software-actions.git")
                developerConnection.set("scm:git:git@bitbucket.org:atlassian/jira-software-actions.git")
            }
        }
    }
